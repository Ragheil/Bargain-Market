...
<script>
	$(document).ready(function(){
		...
		$("#btn_signup").click(function(e){
			...
			if ($("#fname").val() === "" || $("#lname").val() === "" || $("#email_addr").val() === "" || $("#pass1").val() === "" || $("#pass2").val() === "" || $("#file_avtar").val() === "") {
				$("#alert").removeClass("d-none").html("Please complete all fields, including image submission.");
			} else {
